...
public class AuthorLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return AuthorLocalServiceUtil.addAuthor((com.lib.model.Author)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return AuthorLocalServiceUtil.deleteAuthor((com.lib.model.Author)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return AuthorLocalServiceUtil.updateAuthor((com.lib.model.Author)arguments[0]);
		}
		...
		if (_methodName17.equals(name) &&
			...
			AuthorLocalServiceUtil.addBookAuthor(((Long)arguments[0]).longValue(),
				(com.lib.model.Author)arguments[1]);
		...
		if (_methodName19.equals(name) &&
			...
			AuthorLocalServiceUtil.addBookAuthors(((Long)arguments[0]).longValue(),
				(java.util.List<com.lib.model.Author>)arguments[1]);
