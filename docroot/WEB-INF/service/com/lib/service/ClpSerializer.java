...
import com.lib.model.AuthorClp;
import com.lib.model.BookClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"NewLibrary-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "NewLibrary-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.lib.model.impl.AuthorImpl")) {
		...
		if (oldModelClassName.equals("com.lib.model.impl.BookImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.lib.NoSuchAuthorException")) {
			return new com.lib.NoSuchAuthorException();
		}

		if (className.equals("com.lib.NoSuchBookException")) {
			return new com.lib.NoSuchBookException();
		}
